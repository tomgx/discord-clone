  ...
  return (
    <div className="select-none absolute bottom-0 left-[60px] h-[50px] w-[220px] bg-[#222224] z-10">
      ...
      <div>
        ...
        <ul>
          <li className="absolute bottom-3 right-[60px] px-1 py-1 mr-2 rounded hover:bg-[#eeeeee18] duration-200 ease-linear">
            <MdMic style={{ color: "#eee" }} className="cursor-pointer" />
          </li>
          <li className="absolute bottom-3 right-[40px] px-1 py-1 mr-1 rounded hover:bg-[#eeeeee18] duration-200 ease-linear">
            <MdHeadsetMic
              style={{ color: "#eee" }}
              className="cursor-pointer"
            />
          </li>
          <li className="cursor-pointer absolute bottom-3 right-[20px] px-1 py-1 -mr-0 rounded  hover:bg-[#eeeeee18] duration-200 ease-linear">
