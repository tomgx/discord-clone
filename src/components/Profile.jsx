    ...
    return (
        <div className='select-none absolute bottom-0 left-[60px] h-[50px] w-[220px] bg-[#222224] z-10'>
            ...
            <div>
                ...
                <MdMic style={{color: '#eee'}} className='cursor-pointer absolute bottom-4 right-[60px] ' />
                <MdHeadsetMic style={{color: '#eee'}} className='cursor-pointer absolute bottom-4 right-[40px]' />
                <FaCog style={{color: '#eee'}} className='cursor-pointer absolute bottom-4 right-[18px] hover:animate-spin ' />
            </div>
        </div>
    )
}
